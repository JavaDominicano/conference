...
var fetchUrl = getUsefulContents("lang", "/archive/jconf2021/json/speakers/"+speakerId);
...
fetch(fetchUrl)
    ...
    .then(function (speakerJson) {
        ...
        findSessionBySpeakerId(getUsefulContents("lang", "/archive/jconf2021/json/sessions"), speaker.id);
