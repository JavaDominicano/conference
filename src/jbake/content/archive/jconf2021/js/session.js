...
var fetchUrl = getUsefulContents("lang", "/archive/jconf2021/json/sessions");
...
fetch(fetchUrl)
    ...
    .then(function (sessionsJson) {
      ...
      sessionList.forEach((session) => {
         ...
         let speakerPromise = getSpeakerById(getUsefulContents("lang", "/archive/jconf2021/json/speakers/"+speakerId));
