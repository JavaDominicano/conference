...
let fetchUrl = getUsefulContents("lang", "/archive/jconf2023/json/speakers/" + speakerId);
...
fetch(fetchUrl)
    ...
    .then(function (speakerJson) {
        ...
        findSessionBySpeakerId(getUsefulContents("lang", "/archive/jconf2023/json/sessions"), speaker.id);
