...
var fetchUrl = getUsefulContents("lang", "/archive/jconf2023/json/sessions");
...
async function processSession(session, sessions){
  ...
  let speaker = await getSpeakerById(getUsefulContents("lang", "/archive/jconf2023/json/speakers/"+speakerId));
