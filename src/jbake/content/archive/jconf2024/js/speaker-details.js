...
let fetchUrl = getUsefulContents("lang", "/archive/jconf2024/json/speakers/" + speakerId);
...
fetch(fetchUrl)
    ...
    .then(function (speakerJson) {
        ...
        findSessionBySpeakerId(getUsefulContents("lang", "/archive/jconf2024/json/sessions"), speaker.id);
