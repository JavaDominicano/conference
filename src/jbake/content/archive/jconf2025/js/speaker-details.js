...
let sessionsJson = await fetchData(getUsefulContents("lang", "/archive/jconf2025/json/sessions"));

let sessionsBySpeaker = filterSessionBySpeaker(sessionsJson, speakerId);

let speakersData = await fetchData(getUsefulContents("lang", "/archive/jconf2025/json/speakers"));
