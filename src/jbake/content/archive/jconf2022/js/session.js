...
var fetchUrl = getUsefulContents("lang", "/archive/jconf2022/json/sessions");
...
fetch(fetchUrl)
    ...
    .then(function (sessionsJson) {
      ...
      sessionList.forEach((session) => {
         ...
         let speakerPromise = getSpeakerById(getUsefulContents("lang", "/archive/jconf2022/json/speakers/"+speakerId));
